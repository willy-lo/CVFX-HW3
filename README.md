...
我們把GANPaint所有可以用到效果跟功能分別都做過了,我們這組覺得最有印象的應該是草地跟樹的那個部分,可能因為顏色跟原本的圖有差,所以轉換完以後會覺得還蠻酷的!以下為所有的情況的圖
...
那這張我們也把GANPaint所有可以用到效果跟功能分別都做過了,我們這組覺得最有印象的應該是sky的那個部分,他把草地那邊全部變天空,把城堡擱置在懸崖旁邊的感覺,我們覺得很酷!以下為所有的情況的圖
